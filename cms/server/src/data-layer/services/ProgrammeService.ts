...
export class ProgrammeService { 
    ...
    public async createProgramme(name: string, description: string, link: string): Promise<IProgramme> {
        try {
    ...
    public async updateProgrammeById(id: string, updates: Partial<IProgramme>): Promise<IProgramme | null> {
        try {
